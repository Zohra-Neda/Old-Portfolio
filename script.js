...
function workSectionProjectFunction() {
  const projectDetails = document.createElement('div');
  projectDetails.classList.add('project-details');
  projectDetails.innerHTML = `
    <h2 class="project-item second-tittle">${workSectionProject.title}</h2>
    <p class="project-item project-p">${workSectionProject.paragraph}</p>
    <ul class="project-item lang-buttons-container">
      <li class="lang-list lang-css"><a class="lang-list-link" href="#">${workSectionProject.lang1}</a></li>
      <li class="lang-list lang-html"><a class="lang-list-link" href="#">${workSectionProject.lang2}</a></li>
...
window.addEventListener('load', workSectionProjectFunction);
...
function cardSectionProjectFunction() {
  ...
  cardSectionProject.forEach((Project) => {
